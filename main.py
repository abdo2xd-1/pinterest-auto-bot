  ...
  {{
    ...
    backup_ideas = [
        ...
        },
        {
            ...
            "description": "Create once, sell forever. Here are high-margin digital products to sell online. #DigitalProducts #Gumroad #MakeMoneyOnline",
...
def send_whatsapp_notification(title, pin_url):
    ...
    chat_id = f"{WHATSAPP_PHONE}@c.us" if "@" not in str(WHATSAPP_PHONE) else WHATSAPP_PHONE
